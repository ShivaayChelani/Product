// Auto-generated comprehensive list of Indian States and Cities
...
export const ALL_INDIAN_CITIES = Array.from(new Set(Object.values(INDIAN_CITIES_BY_STATE).flat())).sort();
